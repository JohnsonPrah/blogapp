...
const Footer = () => {
  return (
    <footer className='bg-gray-50 pt-4 pb-8 xl:pt-8 w-full'>
      <div className='max-w-screen-lg px-4 mx-auto text-gray-500 xl:max-w-screen-xl sm:px-6 md:px-8'>
      <ul className='flex flex-wrap justify-center items-center pb-8 text-lg font-base'>
             <li className="w-1/2 md:w-1/3 lg:w-1/3">
                <div className="text-center">
                    <h2 className="text-gray-700 font-semibold dark:text-gray-200 text-md uppercase mb-4">
                        CATEGORY
                    </h2>
                    <ul>
                        <li className="mb-2 transition-colors duration-200 hover:text-gray-800">
                            <Link href="#">
                                Sports
                            </Link>
                        </li>
            ...
            <li className="w-1/2 md:w-1/3 lg:w-1/3">
                <div className="text-center">
                    ...
                    <ul>
                        <li className="mb-2 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
                            <Link href="#">
                                Youtube
                            </Link>
                        </li>
      ...
      <div className="pt-4 flex border-t border-gray-200 max-w-xs mx-auto items-center justify-between">
            <Link href="#">
